...
// V2、V3版本 — code 与固件 Keyboard_Function_Type（从 KEY_MO0=0x01 起）一一对应
const customKeys = [
  { code: 1, code1: 0, key: "KEY_MO0", icon: "FN 0" },
  { code: 2, code1: 0, key: "KEY_MO1", icon: "FN 1" },
  { code: 3, code1: 0, key: "KEY_MO2", icon: "FN 2" },
  { code: 4, code1: 0, key: "KEY_MO3", icon: "FN 3" },
  { code: 5, code1: 0, key: "KEY_TO0", icon: "TO 0" },
  { code: 6, code1: 0, key: "KEY_TO1", icon: "TO 1" },
  { code: 7, code1: 0, key: "KEY_TO2", icon: "TO 2" },
  { code: 8, code1: 0, key: "KEY_TO3", icon: "TO 3" },
  { code: 9, code1: 0, key: "BL_TOG", icon: "/KeyType/custom_bl_toggle.svg" },
  { code: 10, code1: 0, key: "BL_MOD", icon: "/KeyType/custom_bl_mode_plus.svg" },
  { code: 11, code1: 0, key: "BL_RMOD", icon: "/KeyType/custom_bl_mode_minus.svg" },
  { code: 12, code1: 0, key: "BL_HUI", icon: "/KeyType/custom_bl_hue_plus.svg" },
  { code: 13, code1: 0, key: "BL_HUD", icon: "/KeyType/custom_bl_hue_minus.svg" },
  { code: 14, code1: 0, key: "BL_VAI", icon: "/KeyType/custom_bl_bright_plus.svg" },
  { code: 15, code1: 0, key: "BL_VAD", icon: "/KeyType/custom_bl_bright_minus.svg" },
  { code: 16, code1: 0, key: "BL_SPI", icon: "/KeyType/custom_bl_speed_plus.svg" },
  { code: 17, code1: 0, key: "BL_SPD", icon: "/KeyType/custom_bl_speed_minus.svg" },
  { code: 18, code1: 0, key: "KYE_COLOUR_BOARD_SET", icon: "/KeyType/custom_bl_color_board.svg" },
  { code: 19, code1: 0, key: "BL_DEFINE1", icon: "/KeyType/custom_bl_custom_light1.svg" },
  { code: 20, code1: 0, key: "BL_DEFINE2", icon: "/KeyType/custom_bl_custom_light2.svg" },
  { code: 21, code1: 0, key: "BL_DEFINE3", icon: "/KeyType/custom_bl_custom_light3.svg" },
  { code: 22, code1: 0, key: "BL_DEFINE4", icon: "/KeyType/custom_bl_custom_light4.svg" },
  { code: 23, code1: 0, key: "BL_DEFINE5", icon: "/KeyType/custom_bl_custom_light5.svg" },
  { code: 24, code1: 0, key: "LG_TOG", icon: "/KeyType/custom_lg_tog.svg" },
  { code: 25, code1: 0, key: "LG_MOD", icon: "/KeyType/custom_lg_mod.svg" },
  { code: 26, code1: 0, key: "LG_RMOD", icon: "/KeyType/custom_lg_rmod.svg" },
  { code: 27, code1: 0, key: "LG_HUI", icon: "/KeyType/custom_lg_hui.svg" },
  { code: 28, code1: 0, key: "LG_HUD", icon: "/KeyType/custom_lg_hud.svg" },
  { code: 29, code1: 0, key: "LG_VAI", icon: "/KeyType/custom_lg_vai.svg" },
  { code: 30, code1: 0, key: "LG_VAD", icon: "/KeyType/custom_lg_vad.svg" },
  { code: 31, code1: 0, key: "LG_SPI", icon: "/KeyType/custom_lg_spi.svg" },
  { code: 32, code1: 0, key: "LG_SPD", icon: "/KeyType/custom_lg_spd.svg" },
  { code: 33, code1: 0, key: "SD_TOG", icon: "💡➡️" },
  { code: 34, code1: 0, key: "SD_MOD", icon: "💡➡️➕" },
  { code: 35, code1: 0, key: "SD_RMOD", icon: "💡➡️➖" },
  { code: 36, code1: 0, key: "SD_HUI", icon: "🌈➡️➕" },
  { code: 37, code1: 0, key: "SD_HUD", icon: "🌈➡️➖" },
  { code: 38, code1: 0, key: "SD_VAI", icon: "🔆➡️➕" },
  { code: 39, code1: 0, key: "SD_VAD", icon: "🔆➡️➖" },
  { code: 40, code1: 0, key: "SD_SPI", icon: "⚡➡️➕" },
  { code: 41, code1: 0, key: "SD_SPD", icon: "⚡➡️➖" },
  { code: 42, code1: 0, key: "LT_TOG", icon: "/KeyType/matrix_screen_toggle.svg" },
  { code: 43, code1: 0, key: "LT_MOD", icon: "/KeyType/matrix_screen_mode_plus.svg" },
  { code: 44, code1: 0, key: "LT_RMOD", icon: "/KeyType/matrix_screen_mode_minus.svg" },
  { code: 45, code1: 0, key: "LT_HUI", icon: "/KeyType/matrix_screen_hue_plus.svg" },
  { code: 46, code1: 0, key: "LT_HUD", icon: "/KeyType/matrix_screen_hue_minus.svg" },
  { code: 47, code1: 0, key: "LT_VAI", icon: "/KeyType/matrix_screen_bright_plus.svg" },
  { code: 48, code1: 0, key: "LT_VAD", icon: "/KeyType/matrix_screen_bright_minus.svg" },
  { code: 49, code1: 0, key: "LT_SPI", icon: "/KeyType/matrix_screen_speed_plus.svg" },
  { code: 50, code1: 0, key: "LT_SPD", icon: "/KeyType/matrix_screen_speed_minus.svg" },
  { code: 51, code1: 0, key: "KYE_RESET", icon: "/KeyType/custom_kye_reset.svg" },
  { code: 52, code1: 0, key: "MODE_BLE1", icon: "/KeyType/custom_mode_ble1.svg" },
  { code: 53, code1: 0, key: "MODE_BLE2", icon: "/KeyType/custom_mode_ble2.svg" },
  { code: 54, code1: 0, key: "MODE_BLE3", icon: "/KeyType/custom_mode_ble3.svg" },
  { code: 55, code1: 0, key: "MODE_2P4G", icon: "/KeyType/custom_mode_2p4g.svg" },
  { code: 56, code1: 0, key: "MODE_USB", icon: "/KeyType/custom_mode_usb.svg" },
  { code: 57, code1: 0, key: "BATT_STATUS", icon: "/KeyType/custom_batt_status.svg" },
  { code: 58, code1: 0, key: "BATT_NUM", icon: "/KeyType/custom_batt_status.svg" },
  { code: 59, code1: 0, key: "KYE_SIX_N_CH", icon: "/KeyType/custom_kye_six_nch.svg" },
  { code: 60, code1: 0, key: "KYE_MAC_WIN_CH", icon: "/KeyType/custom_kye_macwin_toggle.svg" },
  { code: 61, code1: 0, key: "KYE_WIN_LOCK_SET", icon: "/KeyType/custom_kye_win_lock_set.svg" },
  { code: 62, code1: 0, key: "KYE_WASD_SET", icon: "/KeyType/custom_kye_wasd_toggle.svg" },
  { code: 63, code1: 0, key: "KYE_SCAK_DELAY_SET", icon: "/KeyType/custom_kye_key_delay_toggle.svg" },
  { code: 64, code1: 0, key: "KYE_F_CHANGE_SET", icon: "/KeyType/custom_kye_frow_mode_toggle.svg" },
  { code: 65, code1: 0, key: "WHEEL_FUCN_SET", icon: "🎡" },
  { code: 66, code1: 0, key: "KYE_TEST_LED_SET", icon: "/KeyType/custom_test_led_set.svg" },
  { code: 67, code1: 0, key: "KEY_ALL_POWER_SET", icon: "⚡" },
  { code: 68, code1: 0, key: "LCD_POWER_SET", icon: "/KeyType/custom_lcd_power.svg" },
  { code: 69, code1: 0, key: "LCD_MODE_SET", icon: "📺⚙️" },
  { code: 70, code1: 0, key: "LCD_GIF_MODE_SET", icon: "🎞️" },
  { code: 71, code1: 0, key: "LCD_USB_SET", icon: "📺🔌" },
  { code: 72, code1: 0, key: "LCD_ISLAND_SET", icon: "🏝️" },
  { code: 73, code1: 0, key: "WHEEL_LEFT_SET", icon: "⬅️🎡" },
  { code: 74, code1: 0, key: "WHEEL_RIGHT_SET", icon: "➡️🎡" },
  { code: 75, code1: 0, key: "WHEEL_DOWN_SET", icon: "✔️🎡" },
  { code: 76, code1: 0, key: "KYE_TEST_SET", icon: "🧪" },
  { code: 77, code1: 0, key: "BL_LIGHT_MOD", icon: "/KeyType/custom_bl_tog.svg" },
  { code: 78, code1: 0, key: "WWW_DRIVE", icon: "/KeyType/custom_www_drive.svg" },
];
// V1版本
const formerCustom = [
