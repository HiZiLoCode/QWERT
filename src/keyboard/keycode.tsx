...
const customKeys = [
  ...
  { code: 18, code1: 0, key: "Color Board", icon: "🎨" },
  { code: 19, code1: 0, key: "Custom Light 1", icon: "✨1️⃣" },
  { code: 20, code1: 0, key: "Custom Light 2", icon: "✨2️⃣" },
  { code: 21, code1: 0, key: "Custom Light 3", icon: "✨3️⃣" },
  { code: 22, code1: 0, key: "Custom Light 4", icon: "✨4️⃣" },
  { code: 23, code1: 0, key: "Custom Light 5", icon: "✨5️⃣" },
  { code: 24, code1: 0, key: "Logo Light Toggle", icon: "💡🔆" },
  { code: 25, code1: 0, key: "Logo Light Mode +", icon: "💡🔆➕" },
  { code: 26, code1: 0, key: "Logo Light Mode -", icon: "💡🔆➖" },
  { code: 27, code1: 0, key: "Logo Light Hue +", icon: "🌈🔆➕" },
  { code: 28, code1: 0, key: "Logo Light Hue -", icon: "🌈🔆➖" },
  { code: 29, code1: 0, key: "Logo Light Bright +", icon: "🔆🔆➕" },
  { code: 30, code1: 0, key: "Logo Light Bright -", icon: "🔆🔆➖" },
  { code: 31, code1: 0, key: "Logo Light Speed +", icon: "⚡🔆➕" },
  { code: 32, code1: 0, key: "Logo Light Speed -", icon: "⚡🔆➖" },
  ...
  { code: 42, code1: 0, key: "Matrix Light Toggle", icon: "💡🔲" },
  { code: 43, code1: 0, key: "Matrix Light Mode +", icon: "💡🔲➕" },
  { code: 44, code1: 0, key: "Matrix Light Mode -", icon: "💡🔲➖" },
  { code: 45, code1: 0, key: "Matrix Light Hue +", icon: "🌈🔲➕" },
  { code: 46, code1: 0, key: "Matrix Light Hue -", icon: "🌈🔲➖" },
  { code: 47, code1: 0, key: "Matrix Light Bright +", icon: "🔆🔲➕" },
  { code: 48, code1: 0, key: "Matrix Light Bright -", icon: "🔆🔲➖" },
  { code: 49, code1: 0, key: "Matrix Light Speed +", icon: "⚡🔲➕" },
  { code: 50, code1: 0, key: "Matrix Light Speed -", icon: "⚡🔲➖" },
  { code: 51, code1: 0, key: "Reset", icon: "♻️" },
  { code: 52, code1: 0, key: "BLE Mode 1", icon: "📶1️⃣" },
  { code: 53, code1: 0, key: "BLE Mode 2", icon: "📶2️⃣" },
  { code: 54, code1: 0, key: "BLE Mode 3", icon: "📶3️⃣" },
  { code: 55, code1: 0, key: "2.4G Mode", icon: "📡" },
  { code: 56, code1: 0, key: "USB Mode", icon: "🔌" },
  { code: 57, code1: 0, key: "Battery Status", icon: "🔋" },
  { code: 58, code1: 0, key: "6K/NK Toggle", icon: "⌨️6️⃣" },
  { code: 59, code1: 0, key: "Win Toggle", icon: "🪟" },
  { code: 59, code1: 1, key: "MAC/Win Toggle", icon: "💻" },
  { code: 60, code1: 0, key: "Win Lock Toggle", icon: "🔒🪟" },
...
const formerCustom = [
  ...
  { code: 41, code1: 0, key: "KYE_RESET", icon: "🔄" },
  { code: 42, code1: 0, key: "MODE_BLE1", icon: "📶1️⃣" },
  { code: 43, code1: 0, key: "MODE_BLE2", icon: "📶2️⃣" },
  { code: 44, code1: 0, key: "MODE_BLE3", icon: "📶3️⃣" },
  { code: 45, code1: 0, key: "MODE_2P4G", icon: "📡" },
  { code: 46, code1: 0, key: "MODE_USB", icon: "🔌" },
  { code: 47, code1: 0, key: "BATT_STATUS", icon: "🔋" },
  { code: 48, code1: 0, key: "KYE_SIX_NCH", icon: "6️⃣" },
  { code: 49, code1: 0, key: "KYE_MAC_WINCH", icon: "🖥️" },
  { code: 50, code1: 0, key: "KYE_WIN_LOCK_SET", icon: "🔒" },
...
const singleCustom = [
  ...
  { code: 38, code1: 0, key: "Reset", icon: "🔄" },
  { code: 39, code1: 0, key: "6K/NK Toggle", icon: "6️⃣" },
  { code: 40, code1: 0, key: "MAC/Win Toggle", icon: "💻🪟" },
  { code: 41, code1: 0, key: "Win Lock Toggle", icon: "🔒🪟" },
